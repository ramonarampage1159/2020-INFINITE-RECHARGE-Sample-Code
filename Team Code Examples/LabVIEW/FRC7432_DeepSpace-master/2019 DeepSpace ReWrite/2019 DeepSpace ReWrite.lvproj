...
<Project Type="Project" LVVersion="18008000">
	...
	<Property Name="varPersistentID:{011A0E87-3D65-4F5E-8F14-016C6300A76E}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Intake Front Robot Centric</Property>
	<Property Name="varPersistentID:{0306E48A-1EF4-4463-9BB9-C741DFB7D13D}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/State</Property>
	<Property Name="varPersistentID:{0BCD3FA5-46DC-4F65-9510-8FCA0CEBBB7C}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Back Right Motor Throttle</Property>
	<Property Name="varPersistentID:{0C670EB8-C4BB-44E5-BCCC-0454E3A9F5E4}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Start Angle</Property>
	<Property Name="varPersistentID:{34440690-179C-4D95-BC63-331FF934EF46}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Driver Joystick Rotation</Property>
	<Property Name="varPersistentID:{3B307E68-A6F7-461D-AB4B-76CB95DEA42F}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Back Right Motor Direction</Property>
	<Property Name="varPersistentID:{3E8042FC-710C-4D62-850A-03D63BE1DAAE}" Type="Ref">/Target/Shared Variables.lvlib/NavX/Roll</Property>
	<Property Name="varPersistentID:{49EE3669-89C0-4DE5-ACD6-0CA06E17798A}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Strafe Correction On</Property>
	<Property Name="varPersistentID:{5245F713-D8C4-4267-AC39-75452331BD3A}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Right Reverse Adjust</Property>
	<Property Name="varPersistentID:{524FC0C9-B6C0-41E8-A513-E7E943CEDEAA}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Strafe Correction T F</Property>
	<Property Name="varPersistentID:{5E09626A-FECD-4F78-A267-911654DA047E}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Low Gear</Property>
	<Property Name="varPersistentID:{5E701110-DE99-4D34-8607-67A03EB343E4}" Type="Ref">/Target/Shared Variables.lvlib/Vision/Tape_Correction</Property>
	<Property Name="varPersistentID:{68D8C7FB-746C-4348-977D-38CE4ED69DE7}" Type="Ref">/Target/Shared Variables.lvlib/Vision/Tape Tracking</Property>
	<Property Name="varPersistentID:{6BCF5408-3C41-472A-8B36-D2CDDDDC2F26}" Type="Ref">/Target/Shared Variables.lvlib/NavX/Pitch</Property>
	<Property Name="varPersistentID:{72ED0C04-6C13-4203-941B-AA32C9516021}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Driver Joystick X</Property>
	<Property Name="varPersistentID:{7DB559B9-7526-4837-ABDF-EF07DBBF97ED}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Left Forward Adjust</Property>
	<Property Name="varPersistentID:{865ADA7C-6358-4212-B638-39D8AE76705D}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Adjust Speed</Property>
	...
	<Property Name="varPersistentID:{CC93E70F-7986-4136-B2C8-7DAEC5E10A13}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Front Right Motor Throttle</Property>
	<Property Name="varPersistentID:{CCDCB257-F066-4CC9-A5D7-32F3F458867A}" Type="Ref">/Target/Shared Variables.lvlib/Vision/Ball_Correction</Property>
	<Property Name="varPersistentID:{CCF691A2-DE73-49FE-AA8C-DE71DEE617F5}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Loops_of_Z=0</Property>
	<Property Name="varPersistentID:{CEEE133E-2F6F-4347-862E-9EA1A6368365}" Type="Ref">/Target/Shared Variables.lvlib/NavX/Follow Yaw</Property>
	<Property Name="varPersistentID:{D2CCDECA-0A3D-423F-BC90-71CA5D50B4C3}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Front Right Motor Direction</Property>
	<Property Name="varPersistentID:{DFF0346A-D09B-4EDD-8C2D-BFA7C97D085F}" Type="Ref">/Target/Shared Variables.lvlib/Vision/Ball_Tracking</Property>
	<Property Name="varPersistentID:{E368DCCC-AF40-4F58-93BE-4FF0822D4401}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Tracks Down</Property>
	<Property Name="varPersistentID:{E4D7DC01-AB8C-4A7D-AD37-6A165650311B}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Left Reverse Adjust</Property>
	<Property Name="varPersistentID:{E7772806-F127-47CB-98C7-1FB3A77718A4}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Driver Joystick Y</Property>
	<Property Name="varPersistentID:{EDAD9615-438E-4328-A7B1-6CF357FA6C54}" Type="Ref">/Target/Shared Variables.lvlib/Drive Train/Right Forward Adjust</Property>
	<Property Name="varPersistentID:{F7678A97-DB40-451E-BEE2-4A3C6D2E7F2C}" Type="Ref">/Target/Shared Variables.lvlib/NavX/Heading</Property>
